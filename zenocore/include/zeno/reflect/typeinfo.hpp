...
#include <zeno/reflect/traits/constant_eval.hpp>
#include <zeno/reflect/utils/assert>
...
namespace reflect
{
    ...
    class ZENO_API RTTITypeInfo {
    public:
        // Important: This constructor is internal, don't use it
        RTTITypeInfo(const char* in_name, std::size_t hashcode, size_t flags, size_t decayed_hash = 0);
