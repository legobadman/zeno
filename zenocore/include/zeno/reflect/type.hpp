...
namespace reflect 
{
    ...
    struct ReflectedTypeInfo final {
        ...
        ZENO_API ~ReflectedTypeInfo();
    };

    struct T_NullTypeArg {};

    class ZENO_API TypeHandle {
        mutable union {
    ...
    class ZENO_API ICanHasMetadata {
    public:
    ...
    class ZENO_API TypeBase : public ICanHasMetadata {
    protected:
    ...
    */
    ...
    class ZENO_API IBelongToParentType {
    public:
    ...
    class ZENO_API ITypeConstructor : public IBelongToParentType, public IHasParameter {
    public:
    ...
    class ZENO_API IMemberFunction : public IBelongToParentType, public IHasParameter, public IHasName, public IHasQualifier, public ICanHasMetadata {
    public:
    ...
    class ZENO_API IMemberField : public IBelongToParentType, public IHasName, public ICanHasMetadata {
    public:
        template <typename T>
