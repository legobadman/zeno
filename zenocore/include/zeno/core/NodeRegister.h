...
namespace zeno {
	...
	public:
		...
		ZENO_API int registerNodeClass(INode2* (*ctor)(), void (*dtor)(INode2*), std::string const& clsname, Descriptor const& desc);
		ZENO_API int registerNodeClass(INode2* (*ctor)(), void (*dtor)(INode2*), std::string const& nodecls, CustomUI const& customui);
