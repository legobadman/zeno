...
ZENO_API std::unique_ptr<zeno::PrimitiveObject> primMergeWithFacesetMatid2(std::vector<zeno::PrimitiveObject *> const &primList, std::string const &tagAttr = {}, bool tag_on_vert = true, bool tag_on_face = false);
