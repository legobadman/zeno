...
struct ParticlesNeighborBvhWrangle : zeno::INode {
    virtual void apply() override {
        ...
        auto primNei = get_input_Geometry("primNei")->toPrimitiveObject();
        //auto lbvh = get_input<zeno::LBvh>("lbvh");
        //auto lbvhobj = clone_input("lbvh");
        auto lbvh = safe_uniqueptr_cast<zeno::LBvh>(clone_input("lbvh"));
        ...
        bvh_vectors_wrangle(exec, chs, chs2, prim->attr<zeno::vec3f>("pos"),
            primNei->attr<zeno::vec3f>("pos"), get_input2_bool("is_box"),
...
ZENDEFNODE(ParticlesNeighborBvhWrangle,
    {
        {{gParamType_Geometry, "prim", "", zeno::Socket_ReadOnly},
         {gParamType_Geometry, "primNei", "", zeno::Socket_ReadOnly},
