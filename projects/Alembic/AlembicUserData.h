...
// Simplified UserData for zs_alembic: implements IUserData2 without zeno::reflect::Any.
// Storage is per-type maps (no type erasure).
struct AlembicUserData : IUserData2 {
    ...
    AlembicUserData() = default;
    AlembicUserData(const AlembicUserData&) = default;
    AlembicUserData& operator=(const AlembicUserData&) = default;
